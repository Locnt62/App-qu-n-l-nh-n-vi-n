...
public class NhanVienDAO {
    ...
    public List<NhanVienDTO> LayNhanVienTheoPhongBan(int mapb){
        ...
        String sql=" select * from " + Database.TABLE_NHANVIEN + " , " + Database.TABLE_PHONGBAN + " where " + Database.TABLE_NHANVIEN + "." + Database.MaPB_PhongBan + " = " + Database.TABLE_PHONGBAN + "." + Database.MaPB_PhongBan + " and " + Database.TABLE_NHANVIEN + "." + Database.MaPB_PhongBan + " = " + mapb + " ; " ;
    ...
    public NhanVienDTO LayNhanVienTheoMa(int id){
        ...
        String sql=" select * from " + Database.TABLE_NHANVIEN + ","
                ...
                + Database.MaPB_PhongBan + " = " + Database.TABLE_PHONGBAN + "."
                + Database.MaPB_PhongBan + " and " + Database.TABLE_NHANVIEN + "."
                + Database.MaNV_NhanVien + " = " + id;
    ...
    public void XoaNhanVien(int id){
        db=dbhelper.getWritableDatabase();
        db.delete(Database.TABLE_NHANVIEN,Database.MaNV_NhanVien + "=?", new  String[]{String.valueOf(id)});
    }
